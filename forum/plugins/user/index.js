        ...
        if (user.email) {
          return Nimbus.Share.add_share_user_real(user.email, function(u) {
            ...
            if (Nimbus.Auth.service = 'Firebase') {
              Nimbus.Client.Firebase.register_user(user.email, function(data) {
